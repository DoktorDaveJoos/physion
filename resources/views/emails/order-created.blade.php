...
<div class="py-12 flex flex-col items-center space-y-6">
    ...
    <div class="bg-white flex flex-col items-center mx-4 sm:w-2/3 rounded-md py-10 py-4 px-4 space-y-6">
        <div class="flex flex-col items-center">
            <p class="text-gray-800 font-semibold text-md">Hey, {{ $customer }}!</p>
            <p class="text-gray-600 text-sm">Danke für Deine Bestellung!</p>
        </div>
        <div class="flex flex-col sm:max-w-xl items-center">
            <p class="text-gray-600 text-md">

                Deine Bestellung wird nun von einem unserer Energieberater geprüft.
                Falls es keine Rückfragen gibt, werden wir Dir den Energieausweis unverzüglich via Email
                zukommen lassen.

            </p>
            <p class="text-gray-600 text-md mt-6">

                <strong>Rechnung:</strong> Die Rechnungserstellung wird über den Beizahldienstleister abgewickelt.
                Du erhältst in Kürze eine Email mit der Rechnung über deine Bestellung.

            </p>
            <p class="text-gray-600 text-md mt-6">

                <strong>Ein kleiner Reminder:</strong> Der Energieausweis ist in seiner digitalen Form rechtsgültig.
                Zu beachten ist die Registriernummer: Diese ist beim DIBt (Deutsches Institut für Bautechnik)
                hinterlegt.
