...
const hasOldHeatingSystems = computed(() => {
    return (
...
const hasHeatingSystems = computed(
...
<template>
    <div class="rounded-lg min-h-[250px] bg-gray-100 p-4 flex flex-col">
        ...
        <div
            v-if="hasHeatingSystems && !hasOldHeatingSystems"
