...
import { FireIcon, TrashIcon } from '@heroicons/vue/24/outline';
...
const addConsumption = () => {
    form.transform((data) => ({
        ...
        route('buildings.consumptions.store', {
...
const deleteConsumption = (id) => {
    router.delete(
        route('buildings.consumptions.destroy', {
            building: route().params.building,
            consumption: id,
        }),
        {
...
const steps = [
    ...
    {
        name: 'Verbrauch',
        route: route('buildings.consumptions.show', {
            building: route().params.building,
        }),
    },
];
