...
const submit = () => {
    ...
    })).post(route('buildings.products.isfp.store', props.building.data.id));
};
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-blue-700">
                                                ...
                                                Kontaktdaten des
                                                <strong
                                                    >Rechnungsempfängers</strong
                                                >
                                                ein. Der
                                                <strong>Zuschuss</strong> durch
                                                die Bafa wird auf das Konto des
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                <div
                                    ...
                                    <p>
                                        ...
                                        Energieberatung. Dieser Antrag muss in
                                        jedem Fall vor der Erstellung des iSFP
                                        gestellt werden um den Zuschuss zu
                                        erhalten. Anschließend meldet sich
                                        Bauzertifikate bei Ihnen bezüglich eines
                                        Vor-Ort-Termins. Im Anschluss erhalten
                                        Sie den iSFP.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-yellow-700">
                                    <p>
                                        Ein Sanierungsfahrplan (iSFP) kann nur
                                        für ganze Gebäude ausgestellt werden.
                                    </p>
                                </div>
                            </div>
                        </div>
