...
const submit = () => {
    form.post(route('buildings.products.bza.store', props.building.data.id));
};
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-blue-700">
                                                ...
                                                ein. Der
                                                <strong>Kredit</strong> muss
                                                dann an diese Person ausgezahlt
                                                werden.
                                            </p>
                                        </div>
                        ...
                        <div class="bg-white rounded-b-lg">
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                <div
                                    ...
                                    <p>
                                        Der BzA wurde beantragt und wird in
                                        Kürze erstellt. Bezüglich des
                                        Zielzustands des Gebäudes werden wir uns
