...
import OrderBaseDataHub from '../../../Components/OrderBaseDataHub.vue';
...
const saferEmailAddress = computed(() => {
    const email = props.order.owner.email;
...
<template>
    <template v-if="$page.props.user">
        <sidebar-layout>
            <stepper-wrapper-hub>
                <suspense>
                    <order-base-data-hub :order="order" />
                </suspense>
            </stepper-wrapper-hub>
        </sidebar-layout>
    </template>
                ...
                <information-box to="#infobox">
                    <div class="flex flex-col">
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            Mit der vorliegenden Bestellnummer haben Sie
                            jederzeit die Möglichkeit, Ihren Ausweis
                            wiederzufinden, die Bestellung abzuschließen oder
                            nach Abschluss den Ausweis herunterzuladen.
                        </p>
                        <p class="text-xs text-gray-500 mt-2">
                            Bitte beachten Sie, dass die Bestellnummer auch per
                            Email an die von Ihnen angegebene Adresse:
                            {{ saferEmailAddress }} gesendet wurde.
                        </p>
                    </div>
                </information-box>
                <Suspense>
