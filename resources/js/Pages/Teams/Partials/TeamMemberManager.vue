    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                <template #title> Mitarbeiter hinzufügen </template>

                <template #description>
                    Füge ein neues Teammitglied zu deinem Team hinzu und
                    ermögliche ihm/ihr die Zusammenarbeit mit dir.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Bitte geben Sie die E-Mail-Adresse der Person an,
                            die Sie gerne zu diesem Team hinzufügen möchten.
                        </div>
                    </div>
        ...
        <div
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title> Anstehende Team-Einladungen </template>

                <template #description>
                    Diese Personen wurden zu Ihrem Team eingeladen und haben
                    eine Einladungs-E-Mail erhalten. Sie können dem Team
                    beitreten, indem sie die Einladungs-E-Mail akzeptieren.
                </template>
        ...
        <div v-if="team.users.length > 0">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Alle Personen, die Teil dieses Teams sind.
                </template>
        ...
        <DialogModal
            ...
            <template #title> Manage Rollen </template>
        ...
        <ConfirmationModal
            ...
            <template #title> Team verlassen </template>
        ...
        <ConfirmationModal
            ...
            <template #content>
                Sind Sie sicher, dass Sie diese Person wirklich aus dem Team
                entfernen möchten?
            </template>
