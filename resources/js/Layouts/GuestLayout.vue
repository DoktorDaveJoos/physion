                                    ...
                                    <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                        <div class="relative bg-white flex flex-col px-3 divide-y">
                                            ...
                                            <div v-for="(category, idx) in products" :key="idx"
                                                ...
                                                <a v-for="solution in category" :key="solution.name"
                                                   :href="solution.href"
                                                   ...
                                                   :class="!solution.active ? 'opacity-40 cursor-not-allowed' : ''">
                                                    <div
                                                        ...
                                                        <component :is="solution.icon" class="h-6 w-6"
                                                                   aria-hidden="true" />
                                                    </div>
                                                    <div class="ml-4">
                                            ...
                                            <InertiaLink :href="route('login')"
                                               class="-m-3 flow-root rounded-md p-3 hover:bg-gray-100">
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="ml-3 inline-flex items-center rounded-full bg-indigo-100 px-3 py-0.5 text-xs font-medium leading-5 text-indigo-800">Demnächst
                                                        Verfügbar</span>
                                                </div>
                                                <p class="mt-1 text-sm text-gray-500">Optimieren Sie den Energiebedarf
                                                    und
