<template>
    ...
    <div class="lg:flex lg:items-center lg:justify-between">
        <div class="min-w-0 flex-1">
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            <a href="#"
                               class="text-sm font-medium text-gray-500 hover:text-gray-700">Bedarfsausweis</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                               class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Allgemein</a>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <span class="text-gray-500">{{ product.zip }}, {{ product.city }}</span>
            <div class="mt-4 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
