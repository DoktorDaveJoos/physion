...
class CreateBuildingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'new_building' => 'required|boolean',
            'street' => 'required|string',
            'house_number' => 'required|string',
            'postal_code' => 'required|digits:5',
            'city' => 'required|string',
            'type' => 'required|string',
            'additional_type' => 'required_unless:type,Wohnung|nullable|string',
            'construction_year' => 'required|integer|min:1000|max:'.(date('Y')),
            'floor_area' => 'required|numeric|min:1|max:10000',
            'land_area' => 'nullable|numeric|min:1|max:100000',
            'floors' => 'required_unless:type,Wohnung|nullable|numeric|min:1|max:100',
            'floor' => 'required_if:type,Wohnung|nullable|numeric|min:1|max:100',
            'rooms' => 'nullable|numeric|min:1|max:100',
            'housing_units' => 'required_unless:type,Wohnung|nullable|integer|min:1|max:100',
